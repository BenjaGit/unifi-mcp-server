...
See [../api/mcp-tools.md](../api/mcp-tools.md#firewall-policies-v2-api) for complete documentation.
...
- [x] Document all tools in ../api/mcp-tools.md
...
1. ✅ Complete documentation (../api/mcp-tools.md, docs/features/zbf-status.md)
...
3. **Document:** Update ../api/mcp-tools.md and this status document
...
1. Check ../api/mcp-tools.md for usage examples
...
- [docs/api/mcp-tools.md](../api/mcp-tools.md) - Complete API documentation
